...
function SideBar () {
    ...
    <div className="ps__rail-x" style="width: 250px; left: 0px; bottom: 0px;"><div className="ps__thumb-x" tabindex="0" style="left: 0px; width: 214px;"></div></div><div className="ps__rail-y" style="top: 0px; right: 0px;"><div className="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
